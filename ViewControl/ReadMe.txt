========================================================================
    ACTIVEX CONTROL DLL : ViewControl Project Overview
========================================================================

ControlWizard has created this project for your ViewControl ActiveX Control
...
that make up your ViewControl ActiveX Control DLL.
...
ViewControl.ico
    ...
    is included by the main resource file ViewControl.rc.

/////////////////////////////////////////////////////////////////////////////
CViewCtrl control:

ViewCtrl.h
    This file contains the declaration of the CViewCtrl C++ class.

ViewCtrl.cpp
    This file contains the implementation of the CViewCtrl C++ class.

ViewPpg.h
    This file contains the declaration of the CViewPropPage C++ class.

ViewPpg.cpp
    This file contains the implementation of the CViewPropPage C++ class.

CViewCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CViewCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file ViewControl.rc.
...
stdafx.h, stdafx.cpp
    ...
    named ViewControl.pch and a precompiled types (PCT) file named stdafx.obj.
